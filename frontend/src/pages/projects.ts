      ...
      <div class="admin-modal admin-modal--wide" role="dialog" aria-modal="true">
        ...
        <form id="project-form" class="admin-modal-form" novalidate>
          ...
          <div class="admin-modal-actions">
            ${isEdit ? `<button type="button" class="btn btn-outline" id="modal-reset-btn">${t('projects.btn_reset')}</button>` : ''}
...
function openModal(projet: Projet | null): void {
  ...
  overlay?.querySelector('#modal-reset-btn')?.addEventListener('click', () => {
    if (!projet || !form) return
