            ...
            <div className="geo-main-body">
              <div className="geo-map-container">
                ...
                <nav className="geo-nav" aria-label={t('ranking.nav_label')}>
                  ...
                  <button
                    type="button"
                    className={`geo-nav-tab${!sidebarCollapsed ? ' geo-nav-tab--active' : ''}`}
                    title="Analyse Multicritère (AMC)"
                    aria-pressed={!sidebarCollapsed}
                    onClick={() => toggleSidebar()}
                  >
                    <span className="geo-nav-tab-icon">
                    ...
                    <span className="geo-nav-tab-label">Analyse AMC</span>
                  </button>
                  <button
                    type="button"
              ...
              {rentaViewMode ? (
                <div className="renta-view-block">
                  <div className="renta-view-head">
                    <strong>{rentaTerrainNom || rentaParcelInfo?.ref || `Terrain #${rentaTerrainId}`}</strong>
