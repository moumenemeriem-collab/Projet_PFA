...
COUCHES = [
    {
        ...
        'attributs': [{'nom': 'id_parcelle', 'type': 'string'}, {'nom': 'num_titre_foncier', 'type': 'string'}, {'nom': 'type_immatriculation', 'type': 'string'}, {'nom': 'nature_juridique', 'type': 'string'}, {'nom': 'superficie_m2', 'type': 'number'}, {'nom': 'commune', 'type': 'string'}, {'nom': 'cercle', 'type': 'string'}, {'nom': 'province', 'type': 'string'}, {'nom': 'nature_occupation_code', 'type': 'string'}, {'nom': 'nature_occupation_libelle', 'type': 'string'}, {'nom': 'zone_amenagement', 'type': 'string'}, {'nom': 'statut_foncier', 'type': 'string'}, {'nom': 'origine', 'type': 'string'}, {'nom': 'reference_plan', 'type': 'string'}, {'nom': 'echelle_leve', 'type': 'string'}, {'nom': 'date_creation', 'type': 'string'}, {'nom': 'date_derniere_maj', 'type': 'string'}],
