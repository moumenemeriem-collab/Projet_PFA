...
class ParametreAffectation(models.Model):
    ...
    code = models.CharField(max_length=255, verbose_name="Désignation / Code", db_index=True)
    zone = models.CharField(max_length=150, blank=True, null=True, verbose_name="Zone")
    categorie = models.CharField(max_length=150, blank=True, null=True, verbose_name="Catégorie")
    type_operation = models.CharField(max_length=255, blank=True, null=True, verbose_name="Type d'opération")
    type_construction = models.CharField(max_length=255, blank=True, null=True, verbose_name="Type de construction")
    definition = models.TextField(blank=True, null=True, verbose_name="Définition")
    cos = models.CharField(max_length=150, blank=True, null=True, verbose_name="COS")
    cus = models.CharField(max_length=150, blank=True, null=True, verbose_name="CUS / CES")
    hauteur_max = models.CharField(max_length=150, blank=True, null=True, verbose_name="Hauteur max (m)")
    nombre_etages = models.CharField(max_length=150, blank=True, null=True, verbose_name="Nombre d'étages")
    largeur_min = models.CharField(max_length=150, blank=True, null=True, verbose_name="Largeur min")
    surface_min = models.CharField(max_length=150, blank=True, null=True, verbose_name="Surface min")
    conditions = models.TextField(blank=True, null=True, verbose_name="Conditions")
    statut = models.CharField(max_length=150, blank=True, null=True, verbose_name="Statut")
    source = models.CharField(max_length=500, blank=True, null=True, verbose_name="Source réglementaire")
    date_creation = models.DateTimeField(auto_now_add=True)
    date_mise_a_jour = models.DateTimeField(auto_now=True)
